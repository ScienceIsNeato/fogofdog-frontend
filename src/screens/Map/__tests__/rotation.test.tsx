...
describe('Map Rotation Disabled Tests', () => {
  ...
  // Test removed - rotation/pitch disabled props are simple static props on MapView component
  // This functionality doesn't require integration testing as it's just prop passing
  // The props can be verified by inspecting the MapScreen source code at lines 1022-1023:
