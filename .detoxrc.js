...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      ...
      build:
        'xcodebuild -workspace ios/FogOfDog.xcworkspace -scheme FogOfDog -configuration Debug -sdk iphonesimulator',
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/FogOfDog.app',
      build:
        'xcodebuild -workspace ios/FogOfDog.xcworkspace -scheme FogOfDog -configuration Release -sdk iphonesimulator',
    },
    'android.debug': {
      type: 'android.apk',
